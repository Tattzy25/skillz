          ...
          <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
            ...
            <div className="flex items-center gap-1">
              ...
              >
                ...
                >
                  {isLoading ? (
                    <Square className="h-4 w-4 animate-pulse fill-white text-white" />
                  ) : isRecording ? (
              ...
              >
                <Button
                  ...
                  size="icon"
                  className={cn(
                    "h-8 w-8 rounded-full transition-all duration-200 bg-white text-[#1F2023] hover:bg-white/80",
                    !hasContent && !isLoading && "opacity-50 cursor-not-allowed"
                  )}
                  onClick={() => {
                    if (!isLoading && hasContent) handleSubmit();
                  }}
